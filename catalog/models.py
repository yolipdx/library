...
class Genre(models.Model):
    """
    Model representing a book genre(e.g. Science Fiction, Non Ficition)
    """
...
class Book(models.Model):
    ...
    language = models.CharField(max_length=1, choices=LANG, default='e', help_text='select the languge of this book')
    ...
    def get_absolute_url(self):
        ...
        """
        return reverse('book-detaiil', args=[str(self.id)])
